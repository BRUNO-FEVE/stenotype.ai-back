import { WisperTranscriptionProvider } from "../../providers/implementation/wisper-provider";
...
const createdVideoController = new CreateVideoController(createVideoUsecase);
